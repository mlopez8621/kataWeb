...
<div class="modal fade" id="login_modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" action="login" method="post" enctype="multipart/form-data" id="login-form" novalidate="novalidate">
                {% csrf_token %}
                ...
                <div class="modal-footer btn-toolbar">
                    <button type="submit"id="btnLogin" class="btn btn-default btn-success pull-right">
                        <span class="glyphicon glyphicon-save"></span> Loguear
                    </button>
